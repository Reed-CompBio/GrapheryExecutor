...
def test_identifier_to_string(default_identifier_and_string):
    assert IDENTIFIER_SEPARATOR == "\u200b@"
    assert default_identifier_and_string[1] == "namespace\u200b@variable"
...
def test_assign_color(empty_recorder, default_identifier_and_string):
    ...
    empty_recorder.assign_color(default_identifier_string)
    assert default_identifier_string in empty_recorder._color_mapping
    assert (
        empty_recorder._color_mapping[default_identifier_string]
        == empty_recorder._COLOR_PALETTE[2]
    )

    for i in range(20):
        identifier_string = identifier_to_string(("namespace", f"variable{i}"))
...
def test_register_variable(empty_recorder):
    ...
    result_identifier_string = empty_recorder.register_variable(identifier)
...
def test_process_variable_state(empty_recorder):
    ...
    for i in range(0, len(test_mapping), 2):
        ...
        assert (
            state_info_mapping[empty_recorder._TYPE_HEADER]
            == empty_recorder._TYPE_MAPPING[test_mapping[i + 1]]
        )
...
def test_generating_changes(empty_recorder):
    ...
    assert first_change[empty_recorder._VARIABLE_HEADER][first_var_id_string][
        empty_recorder._REPR_HEADER
    ] == empty_recorder.custom_repr(first_var_value, target_type, set())
    assert (
        first_change[empty_recorder._VARIABLE_HEADER][first_var_id_string][
            empty_recorder._TYPE_HEADER
        ]
        == target_type
    )
    ...
    assert first_change[empty_recorder._ACCESS_HEADER][0][
        empty_recorder._REPR_HEADER
    ] == empty_recorder.custom_repr(accessed_var_value, target_type, set())
    assert (
        first_change[empty_recorder._ACCESS_HEADER][0][empty_recorder._TYPE_HEADER]
        == target_type
    )
...
def test_json_dump(empty_recorder):
    result_string = [
        {
            ...
            "line": _anything,
            "variables": {
                "main\u200b@var_1": {"color": "#A6CEE3", "repr": None, "type": "init"},
                "main\u200b@var_2": {"color": "#1F78B4", "repr": None, "type": "init"},
                "main\u200b@var_3": {"color": "#B2DF8A", "repr": None, "type": "init"},
                "main\u200b@var_4": {"color": "#33A02C", "repr": None, "type": "init"},
            },
        },
        {
            "accesses": [
    ...
    empty_recorder.add_vc_to_last_record(second_var_id_string, second_var_value)
    ...
    empty_recorder.add_vc_to_previous_record(fourth_var_id_string, fourth_var_value)
    ...
    third_var_value = "ab"
    empty_recorder.add_vc_to_previous_record(third_var_id_string, third_var_value)
...
def test_recursive(set_new_recorder):
    result = [
        {
            ...
            "line": _anything,
            "variables": {
                "t\u200b@a": {"color": "#A6CEE3", "repr": None, "type": "init"}
            },
        },
        {"accesses": None, "line": _anything, "variables": None},
        {
    ...
    t()
    assert RecorderResultParser(
        tracer.get_recorder().get_processed_change_list()
    ) == RecorderResultParser(result)
    ...
    result = [
        {
            ...
            "line": 0,
            "variables": {
                "main\u200b@a": {"color": "#A6CEE3", "repr": None, "type": "init"}
            },
        },
    ...
    result = [
        {
            ...
            "variables": {
                "main\u200b@a": {"color": "#A6CEE3", "repr": None, "type": "init"},
                "main\u200b@b": {"color": "#1F78B4", "repr": None, "type": "init"},
            },
        },
    ...
    result = [
        {
            ...
            "line": 0,
            "variables": {
                "call_test\u200b@a": {"color": "#1F78B4", "repr": None, "type": "init"},
                "main\u200b@a": {"color": "#A6CEE3", "repr": None, "type": "init"},
            },
        },
    ...
    result = [
        {
            ...
            "line": 0,
            "variables": {
                "call_test\u200b@b": {"color": "#1F78B4", "repr": None, "type": "init"},
                "main\u200b@a": {"color": "#A6CEE3", "repr": None, "type": "init"},
                "main\u200b@b": {"color": "#B2DF8A", "repr": None, "type": "init"},
            },
        },
    ...
    result = [
        {
            ...
            "line": 0,
            "variables": {
                "call_test\u200b@c": {"color": "#1F78B4", "repr": None, "type": "init"},
                "main\u200b@a": {"color": "#A6CEE3", "repr": None, "type": "init"},
                "main\u200b@b": {"color": "#B2DF8A", "repr": None, "type": "init"},
            },
        },
